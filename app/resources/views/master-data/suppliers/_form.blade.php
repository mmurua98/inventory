<div class="row g-3">
    <div class="col-md-4"><label class="form-label" for="supplier_code">Código</label><input class="form-control" id="supplier_code" name="supplier_code" value="{{ old('supplier_code', $supplier->supplier_code ?? '') }}" required></div>
    ...
    <div class="col-md-6 d-flex align-items-end"><div class="form-check mb-2"><input class="form-check-input" type="checkbox" value="1" id="is_active" name="is_active" {{ old('is_active', $supplier->is_active ?? true) ? 'checked' : '' }}><label class="form-check-label" for="is_active">Activo</label></div></div>
</div>
