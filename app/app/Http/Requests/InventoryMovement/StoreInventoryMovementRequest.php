...
class StoreInventoryMovementRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'reference_id.min' => 'La referencia debe ser mayor a 0.',
            ...
            'lines.*.required' => 'Cada línea del movimiento es obligatoria.',
            'lines.*.array' => 'Cada línea del movimiento debe tener un formato válido.',
